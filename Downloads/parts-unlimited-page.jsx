...
// ============================================================
// Visual dashboard for the Parts Unlimited sync.
// Shows cooldown status, pull budget, and sync history.
// Access: /admin/sync
// ============================================================
...
export default function SyncAdminPage() {
  ...
  const hoursRemaining  = dbStatus?.hoursSinceLastSync !== null
    ? Math.max(0, (dbStatus?.cooldownHours ?? 10) - (dbStatus?.hoursSinceLastSync ?? 0))
    : 0;
  const cooldownPct     = dbStatus?.hoursSinceLastSync !== null
    ? Math.min(100, ((dbStatus?.hoursSinceLastSync ?? 0) / (dbStatus?.cooldownHours ?? 10)) * 100)
    : 100;
    ...
    <div className="sync-wrap">
      ...
      <div className="sync-header">
        ...
        <div style={{fontSize:13, color:"#8a8784", marginTop:4}}>
          Parts Unlimited price file import — 2 pulls per day limit
        </div>
      </div>
      ...
      <div className="sync-body">
          ...
          <div className="card-body">
            ...
            <div className="cooldown-wrap">
              <div className="cooldown-bar-labels">
                ...
                <span style={{color:"#8a8784"}}>{dbStatus?.cooldownHours ?? 10}H WINDOW</span>
              </div>
            ...
            <div className="stat-grid">
              ...
              <div className="stat-box">
                <div className="stat-val">
                  {dbStatus?.hoursSinceLastSync !== null
                    ? `${dbStatus.hoursSinceLastSync}H`
                    : "—"}
                </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
              ...
              <div className="warn-banner" style={{marginBottom:16}}>
                ...
                <div>
                  ...
                  <div style={{fontSize:13, color:"#c2b9b0"}}>
                    Last sync completed {dbStatus?.hoursSinceLastSync}h ago.
                    Next sync allowed at{" "}
                    <strong style={{color:"#f0ebe3"}}>
                      {dbStatus?.nextAllowedAt
                        ? new Date(dbStatus.nextAllowedAt).toLocaleString()
                        : "—"}
                    </strong>
                  </div>
                </div>
            ...
            {/* Force override — hidden by default */}
            {!canSync && !isRunning && (
                ...
                {!showForce ? (
                  ...
                  <div style={{display:"flex", flexDirection:"column", gap:10}}>
                    ...
                    <div style={{display:"flex", gap:10}}>
                      <button className="force-btn" onClick={() => runSync(true)}>
                        FORCE SYNC ANYWAY
                      </button>
                      <button
        ...
        {syncResult && (
          <div className="card" style={{animationDelay:"0.1s"}}>
            <div className="card-head">
              ...
              <span style={M({fontSize:9, color:"#22c55e"})}>
        ...
        {logs.length > 0 && (
          <div className="card" style={{animationDelay:"0.15s"}}>
            <div className="card-head">
              <div className="card-title">SYNC <span>LOG</span></div>
            </div>
        ...
        {dbStatus?.recentLogs?.length > 0 && (
          <div className="card" style={{animationDelay:"0.2s"}}>
            <div className="card-head">
              <div className="card-title">SYNC <span>HISTORY</span></div>
            </div>
                ...
                <tbody>
                  {dbStatus.recentLogs.map((log, i) => (
                    <tr key={i}>
                      ...
                      <td style={{color: log.errors > 0 ? "#ef4444" : "#8a8784"}}>
                        {log.errors ?? 0}
                      </td>
                      <td style={M({fontSize:10, color:"#8a8784"})}>
