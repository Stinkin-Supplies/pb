...
**Status:** Catalog stable ✅ | Variants live ✅ | Era pages live ✅ | Fitment ~20% coverage | pu_fitment promote pending ⚠️
...
| pu_fitment_expanded | 1,640,065 rows | ✅ Complete |
| catalog_variant_groups | 2,887 | ✅ NEW |
| catalog_variant_members | 19,464 | ✅ NEW |
| era_* columns | Backfilled | ✅ 12,721 products tagged |
| harley_models | 299 | ✅ |
...
Run after catalog_fitment_v2 is populated:
...
|------|----------|----------|-------|
| milwaukee-8 | full | 3,815 | ✅ Backfilled |
| twin-cam | full | 8,165 | ✅ Backfilled |
| evolution | full | 5,026 | ✅ Backfilled |
| evo-sportster | full | 1,642 | ✅ Backfilled |
| shovelhead | full | 1,031 | ✅ Backfilled |
| ironhead-sportster | full | 1,091 | ✅ Backfilled |
| chopper | full | 2,002 | ✅ Backfilled |
...
| catalog_variant_groups | 2,887 | ✅ NEW May 20 |
| catalog_variant_members | 19,464 | ✅ NEW May 20 |
