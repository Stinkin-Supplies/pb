        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={onClose}
          ...
          <motion.div initial={{ scale: 0.96, y: 20, opacity: 0 }} animate={{ scale: 1, y: 0, opacity: 1 }} exit={{ scale: 0.96, y: 20, opacity: 0 }} transition={{ duration: 0.2 }}
            ...
            style={{
              ...
              maxHeight: isMobile ? "92svh" : "min(90svh, 900px)",
              overflow: "auto",
              border: "1px solid rgba(52,50,48,0.9)",
              background: "radial-gradient(circle at 0% 0%, rgba(232,98,26,0.13), transparent 28%), #0e0d0c",
              display: "grid",
              gridTemplateColumns: isMobile ? "1fr" : "minmax(260px, 0.9fr) minmax(0, 1.1fr)",
