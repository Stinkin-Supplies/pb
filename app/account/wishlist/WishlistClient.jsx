...
const css = `
  *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
  ...
  .wl-wrap { background:#0a0909; min-height:100vh; color:#f0ebe3; font-family:var(--font-stencil),sans-serif; }
  ...
  .wl-brand { font-family:var(--font-stencil),monospace;font-size:9px;color:#e8621a;letter-spacing:0.14em;margin-bottom:3px; }
  .wl-name { font-size:14px;font-weight:700;color:#f0ebe3;line-height:1.3;margin-bottom:8px; }
  .wl-price { font-family:var(--font-caesar),sans-serif;font-size:22px;color:#f0ebe3;letter-spacing:0.04em;margin-bottom:10px; }
  .wl-stock { font-family:var(--font-stencil),monospace;font-size:9px;letter-spacing:0.1em;margin-bottom:10px; }
  .wl-stock.in { color:#22c55e; }
  .wl-stock.out { color:#8a8784; }
  .wl-actions { display:flex;gap:8px; }
  .wl-add-btn { flex:1;background:#e8621a;border:none;color:#0a0909;font-family:var(--font-caesar),sans-serif;font-size:15px;letter-spacing:0.1em;padding:8px;border-radius:2px;cursor:pointer;transition:background 0.2s; }
  .wl-add-btn:hover { background:#c94f0f; }
  .wl-add-btn:disabled { background:#2a2828;color:#8a8784;cursor:not-allowed; }
  .wl-remove-btn { background:transparent;border:1px solid #2a2828;color:#8a8784;font-family:var(--font-stencil),monospace;font-size:9px;letter-spacing:0.1em;padding:8px 12px;border-radius:2px;cursor:pointer;transition:all 0.2s; }
  ...
  .wl-notify-label { font-family:var(--font-stencil),monospace;font-size:8px;color:#8a8784;letter-spacing:0.1em;flex:1; }
  ...
  .wl-empty-title { font-family:var(--font-caesar),sans-serif;font-size:30px;letter-spacing:0.05em;color:#3a3838;margin-bottom:8px; }
  .wl-empty-sub { font-family:var(--font-stencil),monospace;font-size:9px;color:#8a8784;letter-spacing:0.12em;margin-bottom:20px; }
  .wl-empty-btn { background:#e8621a;border:none;color:#0a0909;font-family:var(--font-caesar),sans-serif;font-size:16px;letter-spacing:0.1em;padding:10px 24px;border-radius:2px;cursor:pointer; }
